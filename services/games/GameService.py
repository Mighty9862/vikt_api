...
class GameService:
    ...
    async def update_timer_status(self, timer: bool, timer_seconds: Optional[int] = None):
        return await self.repository.update_timer_status(timer=timer, timer_seconds=timer_seconds)
    ...
    async def update_current_question(self, current_question: str, answer_for_current_question: str, current_question_image: str, current_answer_image: str, timer_status: bool, show_answer: bool, timer_seconds: Optional[int] = None):
        return await self.repository.update_current_question(current_question=current_question, answer_for_current_question=answer_for_current_question, current_question_image=current_question_image, current_answer_image=current_answer_image, timer_status=timer_status, show_answer=show_answer, timer_seconds=timer_seconds)
